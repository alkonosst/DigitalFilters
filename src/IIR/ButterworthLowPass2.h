...
class ButterworthLowPass2 : public IFilter {
  public:
  ButterworthLowPass2(const uint32_t period_us = 100 * 1000, const FType tau = 1,
                      const FType gain = 1)
  ...
  constexpr static FType _SQRT_2 = 1.4142135623730950488016887242097;
};
